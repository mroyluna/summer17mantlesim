...
%         ax = gca;
%         ax.Position = [0,0,1,1];
%         streamparticles(verts,1,'ParticleAlignment','on','animate',[1]);%pause%)
%         
...
%         ax = gca;
%         ax.Position = [0,0,1,1];
%         streamparticles(verts,1,'ParticleAlignment','on','animate',[1])
%         %pause;
%         iverts = interpstreamspeed(Xr,Yr,Vmeltx,Vmelty,verts,400);
%         sl = streamline(iverts);
%         set(sl,'Marker','.'); daspect([1 1 1])
