...
starty  = 690*ones(length(startx),1);
...
%                savefig('no_convection_20my_dpdx.fig')
%                figure(1); title('')
%                print -dpdf with_convection_50my_690_Tb1300_melt.pdf
%                savefig('with_convection_50my_690_Tb1300_melt.fig')
               figure(4)
                print -dpdf dpdx_stream_10my.pdf
                savefig('dpdx_stream_10my.fig')
            cd(WD1)
